...
import static tones.then.BarsThen.*;
...
public final class BarsThen extends Tracer implements Titled{
	...
	public BarsThen(String...codeLines){
	...
	public DataNode newDebugRoot(int at){
		NodeList barsList=new NodeList(new DataNode(BarsThen.class.getSimpleName(),title()),true);
